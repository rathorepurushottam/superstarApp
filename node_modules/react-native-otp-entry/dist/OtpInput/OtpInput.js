...
exports.OtpInput = (0, react_1.forwardRef)((props, ref) => {
    const { models: { text, inputRef, focusedInputIndex, isFocused, placeholder }, actions: { clear, handlePress, handleTextChange, focus, handleFocus, handleBlur, blur }, forms: { setTextWithRef }, } = (0, useOtpInput_1.useOtpInput)(props);
    ...
    (0, react_1.useImperativeHandle)(ref, () => ({ clear, focus, setValue: setTextWithRef, blur }));
