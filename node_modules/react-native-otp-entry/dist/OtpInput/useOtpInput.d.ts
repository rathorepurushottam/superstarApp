...
export declare const useOtpInput: ({ onTextChange, onFilled, numberOfDigits, disabled, autoFocus, blurOnFilled, type, onFocus, onBlur, placeholder: _placeholder, }: OtpInputProps) => {
    models: {
        text: string;
